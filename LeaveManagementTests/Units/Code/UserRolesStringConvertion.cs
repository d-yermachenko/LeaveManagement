...
namespace LeaveManagementTests.Units.Code {
    ...
    public class UserRolesStringConvertion {
        ...
        public void TestUserRolesToString() {
            UserRoles roles = UserRoles.Administrator | UserRoles.HRManager;
        ...
        public void TestStringToUserRoles() {
            UserRoles expected = UserRoles.Administrator | UserRoles.HRManager;
        ...
        public void TestRolesToRemove() {
            UserRoles oldRoles = UserRoles.Administrator | UserRoles.HRManager;
            UserRoles newRoles = UserRoles.Administrator | UserRoles.Employee;
